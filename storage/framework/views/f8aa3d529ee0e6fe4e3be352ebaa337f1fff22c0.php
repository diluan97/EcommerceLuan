<button class="item"  data-placement="top" title="Xoá" data-toggle="modal" data-target="<?php echo e('#delete' . $item->id); ?>">
    <i class="zmdi zmdi-delete"></i>
</button>
<form method="post" action="<?php echo $item->urlAdminDestroy($product->slug); ?>">
    <input type="hidden" name="_method" value="DELETE" /> <?php echo csrf_field(); ?>

    <div class="modal fade" id="<?php echo e('delete' . $item->id); ?>" role="dialog">
