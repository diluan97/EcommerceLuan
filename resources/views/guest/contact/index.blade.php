				...
				<div class="col-lg-8 contact_col">
                    ...
                    @endif
						...
						<div class="contact_form_container">
							<form action="{{ route('send-lien-he') }}" method="POST" name="contact_form" id="contact_form" class="contact_form">
                                @csrf
                                <div>
									<!-- Subject -->
                                ...
                                {{--  <a href="javascript:submit()"  onclick="this.form['contact_form'].submit()">Gửi Thông Tin Liên Hệ</a>  --}}
							</form>
						</div>
					</div>
				</div>
